...
export default function Home() {
    ...
    useEffect(function () {
        axiosClient.get("/api/services/post/all").then(function (response) {
    ...
    return (
        <div className="container" style={{paddingTop: "60px"}}>
            <h1 align="center">Welcome to News Blog</h1>
            <hr/>
            {
                blogs === null ? <p align="center">Loading blogs......</p> :
                    blogs.length === 0 ? <p align="center">No News Blog Found</p>
                        : blogs.map(function (blog) {
                            console.log("MHSLOG : blog.user_name ->>  ", blog.user_name);
                            console.log("MHSLOG : user.username ->>  ", user.username);
                            return (
